...
<body id="page-top">
    ...
    <header class="d-flex justify-content-between my-4">
        ...
        <p class="text-xl-start">2. Sertifikat Workshop: 1 file</p>
        <p class="text-xl-start">3. Sertifikat Internasional: 1 file berupa Microsoft Office Spesialist (MOS)</p>
        <p class="text-xl-start">4. Sertifikat Nasional: 1 file</p>
        <p class="text-xl-start">5. PPKMB: 1 file</p>
        <p class="text-xl-start">6. Makrab: 1 file</p>
