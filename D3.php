...
<body id="page-top">
    ...
    <header class="d-flex justify-content-between my-4">
        ...
        <p class="text-center-bold" >Syarat-syarat sidang yang wajib di upload</p>
        <br>
        <p class="text-xl-start">1. Sertifikat Seminar: 3 file</p>
        <p class="text-xl-start">2. Sertifikat Workshop: 3 file</p>
        <p class="text-xl-start">3. Sertifikat Internasional: 2 </p>
        <p class="text-xl-start">4. Sertifikat Nasional: 1 file</p>
        <p class="text-xl-start">5. PPKMB: ada</p>
        <p class="text-xl-start">6. Makrab: ada</p>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Silahkan masuk untuk mengunggah persyaratan sidang yang sudah di jelaskan di atas</p>
    <a href="https://script.google.com/macros/s/AKfycbzPGdi0Gv2nW9RLcM2LHbfETbt3UxVx3wlc3kX9YmR-09e0CyU6UlEb1sS9JBEw4ClE/exec" class="btn btn-success stretched-link">Masuk</a>
  </div>
</div>
        <br><br>
