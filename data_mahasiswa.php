...
?>
        ...
        <?php
            ...
            <td><?php echo $no++;?></td>
                ...
                <td><?php echo $data['nama_pembingbing']; ?></td>
                <td><?php echo $data['tanggal_sempro']; ?></td>

                
              
              <td>
              <a href="hapus.php?nim=<?php echo $data['nim'];?>" class="btn btn-success" >Hapus</a>
                <a href="edit.php?nim=<?php echo $data['nim'];?>" class="btn btn-success" >Edit</a>
              </td>
